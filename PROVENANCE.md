...
package, adapted for a live request-serving gateway (ReviewHouse's sources are
batch eval scripts; HealthShield's are a full patient-billing app). No verbatim
